...
import sebron4.BankLogic; // <--- Ändra packagenamn här!!!
 ...
 * 
 * Om du får FAIL men allt ser exakt rätt ut, kan det vara ett whitespace-tecken som
 * inte blir rätt. Troligtvis blir det rätt hos mig ändå så det brukar vara okej
 * ändå att lämna in. 
 * 
 * Nu används den mer generella List<String> istället för ArrayList<String>
 * 
 * Last changes:  2024-09-06
