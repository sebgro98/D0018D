...
import java.time.LocalDateTime; // For capturing date and time of the transaction
import java.time.format.DateTimeFormatter; // For formatting date and time as a string
import java.util.Locale; // For setting locale for currency formatting
